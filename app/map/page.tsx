...
import { Search, MapPin, Navigation, Map as MapIcon, User, ShieldAlert, ArrowLeft, Car } from 'lucide-react';
...
export default function MapPage() {
  ...
  const navBtnClass = 'px-4 py-2 bg-[#0284C7] text-white rounded-lg font-semibold hover:bg-[#0369A1] transition-colors text-sm';
      ...
      <header className="bg-[#E2E8F0] p-4 flex justify-between items-center shadow-sm">
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 ml-2 flex-wrap">
            <Link href="/dashboard" className={navBtnClass}>Trang chủ</Link>
            <Link href="/payment" className={navBtnClass}>Thanh toán</Link>
            <Link href="/history" className={navBtnClass}>Lịch sử</Link>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col items-center ml-4">
            ...
            <span className="text-[10px] font-bold mt-1">Nguyễn Văn Sang</span>
          </div>
        </div>
      </header>
