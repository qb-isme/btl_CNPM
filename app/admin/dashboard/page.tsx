...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F7FB] text-[#1E293B]">
      <header className="bg-[#E2E8F0] px-5 py-4 shadow-sm md:px-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h1 className="text-2xl font-bold tracking-tight md:text-3xl">Hệ Thống Quản Lý Bãi Xe</h1>
            <p className="mt-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#64748B]">
              Giám sát trạng thái thiết bị • IoT Monitoring
            </p>
          </div>

          <div className="flex flex-wrap items-center gap-3 md:gap-5">
            <div className="min-w-36 rounded-full bg-white px-6 py-2 text-center font-mono text-xl shadow-sm">
              {clock || '--:--:--'}
            </div>
            <div className="flex items-center gap-2 rounded-full bg-[#D1FAE5] px-6 py-2 font-semibold text-[#047857] shadow-sm">
              <span className="size-2 rounded-full bg-[#10B981]" />
              Online
            </div>
            <div className="flex items-center gap-3">
              <div className="flex size-12 items-center justify-center rounded-full bg-[#7CC4FF] font-semibold text-[#075985]">
                KT
              </div>
              <div className="text-sm">
                <div className="font-semibold">Nguyễn Văn A</div>
                <div className="text-[#64748B]">Nhân viên kỹ thuật</div>
              </div>
            </div>
          </div>
        </div>
